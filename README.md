...
- **Без подписки** после первого ответа новые вопросы не обрабатываются (если задан `PAYMENT_PROVIDER_TOKEN`); подписка **100 ₽ / месяц** или **600 ₽ / год** (настраивается копейками в `.env`).
