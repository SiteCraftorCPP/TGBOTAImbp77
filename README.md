...
- **Без подписки** после первого полноценного ответа дальше — экран с кнопками оплаты; тарифы **100 ₽ / месяц** или **600 ₽ / год** (копейки в `.env`). Для реальных платежей нужен `PAYMENT_PROVIDER_TOKEN`.
